...
freMTPLfreq$CarAge[freMTPLfreq$CarAge>35] <- 35

model_dat <- data.frame(freMTPLfreq[,c('DriverAge','CarAge','ClaimNb','Power','Brand','Gas','Region')], 
...
readr::write_csv(model_dat, path = 'policy_dat_v2.csv')
