...
def make_optimizer_class(cls):
    class DPOptimizerClass(cls):
        def __init__(self, l2_norm_clip, noise_multiplier, minibatch_size,
                     microbatch_size, nonprivate=False, *args, **kwargs):
            ...
            self.nonprivate = nonprivate

            for group in self.param_groups:
                group['accum_grads'] = [torch.zeros_like(param.data)
                                        if param.requires_grad
                                        else None for param in group['params']]
        ...
        def microbatch_step(self):
            ...
            # return total_norm  # To compute median gradient norm
